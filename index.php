...
elseif(!empty($_POST['btn_submit'])) {
	...
	下記の内容でお問い合わせを受け付けました。\n\n";
		...
		// メール送信
		mb_send_mail( $_POST['email'], $auto_reply_subject, $auto_reply_text, $body, $header);
		...
		// 運営側へメール送信
		mb_send_mail( 'webmaster@gray-code.com', $admin_reply_subject, $admin_reply_text, $body, $header);
	} else {
		$page_flag = 0;
	}
}
